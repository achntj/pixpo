  ...
  "use strict";
   ...
   if (mapDiv.length) {  
     var myOptions = {
         zoom: 10,
   scrollwheel: false,
         center: new google.maps.LatLng(28.5272181, 77.0688999),
         mapTypeId: google.maps.MapTypeId.ROADMAP
     };
     var map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);
     var marker = new google.maps.Marker({
         map: map,
         position: new google.maps.LatLng(28.5272181, 77.0688999)
     });
     var infowindow = new google.maps.InfoWindow({
         content: '<strong>PIXPO MEDIA</strong><br>5/2,INS Building, Rafi Marg, New Delhi-110001<br>'
     });
